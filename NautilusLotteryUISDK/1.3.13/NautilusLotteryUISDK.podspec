Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusCoreSDK", "1.3.13"
  spec.dependency "NautilusContainerSDK", "1.3.13"
  spec.dependency "NautilusConfigSDK", "1.3.13"
  spec.dependency "NautilusIdentifySDK", "1.3.13"
  spec.dependency "NautilusLoggingSDK", "1.3.13"
  spec.dependency "NautilusImagingSDK", "1.3.13"
  spec.dependency "NautilusAnalyticsSDK", "1.3.13"
  spec.dependency "NautilusUISDK", "1.3.13"
  spec.dependency "NautilusLotterySDK", "1.3.13"
  spec.dependency "NautilusServerTimeSDK", "1.3.13"
