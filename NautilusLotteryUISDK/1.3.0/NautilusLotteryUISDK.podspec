Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusCoreSDK", "1.3.0"
  spec.dependency "NautilusContainerSDK", "1.3.0"
  spec.dependency "NautilusConfigSDK", "1.3.0"
  spec.dependency "NautilusIdentifySDK", "1.3.0"
  spec.dependency "NautilusLoggingSDK", "1.3.0"
  spec.dependency "NautilusImagingSDK", "1.3.0"
  spec.dependency "NautilusAnalyticsSDK", "1.3.0"
  spec.dependency "NautilusUISDK", "1.3.0"
  spec.dependency "NautilusLotterySDK", "1.3.0"
  spec.dependency "NautilusServerTimeSDK", "1.3.0"
