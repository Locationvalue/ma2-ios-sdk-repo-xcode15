Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusImagingSDK", "1.6.10"
  spec.dependency "NautilusAnalyticsSDK", "1.6.10"
  spec.dependency "NautilusUISDK", "1.6.10"
  spec.dependency "NautilusLotterySDK", "1.6.10"
  spec.dependency "NautilusServerTimeSDK", "1.6.10"
