Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusCoreSDK", "1.6.8"
  spec.dependency "NautilusContainerSDK", "1.6.8"
  spec.dependency "NautilusConfigSDK", "1.6.8"
  spec.dependency "NautilusIdentifySDK", "1.6.8"
  spec.dependency "NautilusLoggingSDK", "1.6.8"
  spec.dependency "NautilusImagingSDK", "1.6.8"
  spec.dependency "NautilusAnalyticsSDK", "1.6.8"
  spec.dependency "NautilusUISDK", "1.6.8"
  spec.dependency "NautilusLotterySDK", "1.6.8"
  spec.dependency "NautilusServerTimeSDK", "1.6.8"
