Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusCoreSDK", "1.2.5"
  spec.dependency "NautilusContainerSDK", "1.2.5"
  spec.dependency "NautilusConfigSDK", "1.2.5"
  spec.dependency "NautilusIdentifySDK", "1.2.5"
  spec.dependency "NautilusLoggingSDK", "1.2.5"
  spec.dependency "NautilusImagingSDK", "1.2.5"
  spec.dependency "NautilusAnalyticsSDK", "1.2.5"
  spec.dependency "NautilusUISDK", "1.2.5"
  spec.dependency "NautilusLotterySDK", "1.2.5"
  spec.dependency "NautilusServerTimeSDK", "1.2.5"
