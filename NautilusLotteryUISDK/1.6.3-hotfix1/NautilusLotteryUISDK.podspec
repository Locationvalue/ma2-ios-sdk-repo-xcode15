Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusCoreSDK", "1.6.3-hotfix1"
  spec.dependency "NautilusContainerSDK", "1.6.3-hotfix1"
  spec.dependency "NautilusConfigSDK", "1.6.3-hotfix1"
  spec.dependency "NautilusIdentifySDK", "1.6.3-hotfix1"
  spec.dependency "NautilusLoggingSDK", "1.6.3-hotfix1"
  spec.dependency "NautilusImagingSDK", "1.6.3-hotfix1"
  spec.dependency "NautilusAnalyticsSDK", "1.6.3-hotfix1"
  spec.dependency "NautilusUISDK", "1.6.3-hotfix1"
  spec.dependency "NautilusLotterySDK", "1.6.3-hotfix1"
  spec.dependency "NautilusServerTimeSDK", "1.6.3-hotfix1"
