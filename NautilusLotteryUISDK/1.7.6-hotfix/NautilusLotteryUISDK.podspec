Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusCoreSDK", "1.7.6-hotfix"
  spec.dependency "NautilusContainerSDK", "1.7.6-hotfix"
  spec.dependency "NautilusConfigSDK", "1.7.6-hotfix"
  spec.dependency "NautilusIdentifySDK", "1.7.6-hotfix"
  spec.dependency "NautilusLoggingSDK", "1.7.6-hotfix"
  spec.dependency "NautilusImagingSDK", "1.7.6-hotfix"
  spec.dependency "NautilusAnalyticsSDK", "1.7.6-hotfix"
  spec.dependency "NautilusUISDK", "1.7.6-hotfix"
  spec.dependency "NautilusLotterySDK", "1.7.6-hotfix"
  spec.dependency "NautilusServerTimeSDK", "1.7.6-hotfix"
