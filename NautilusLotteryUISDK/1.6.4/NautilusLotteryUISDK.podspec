Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusConfigSDK", "1.6.4"
  spec.dependency "NautilusIdentifySDK", "1.6.4"
  spec.dependency "NautilusLoggingSDK", "1.6.4"
  spec.dependency "NautilusImagingSDK", "1.6.4"
  spec.dependency "NautilusAnalyticsSDK", "1.6.4"
  spec.dependency "NautilusUISDK", "1.6.4"
  spec.dependency "NautilusLotterySDK", "1.6.4"
  spec.dependency "NautilusServerTimeSDK", "1.6.4"
