Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusConfigSDK", "1.5.7"
  spec.dependency "NautilusIdentifySDK", "1.5.7"
  spec.dependency "NautilusLoggingSDK", "1.5.7"
  spec.dependency "NautilusImagingSDK", "1.5.7"
  spec.dependency "NautilusAnalyticsSDK", "1.5.7"
  spec.dependency "NautilusUISDK", "1.5.7"
  spec.dependency "NautilusLotterySDK", "1.5.7"
  spec.dependency "NautilusServerTimeSDK", "1.5.7"
