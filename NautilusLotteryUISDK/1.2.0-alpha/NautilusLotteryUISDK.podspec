Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusConfigSDK", "1.2.0-alpha"
  spec.dependency "NautilusIdentifySDK", "1.2.0-alpha"
  spec.dependency "NautilusLoggingSDK", "1.2.0-alpha"
  spec.dependency "NautilusImagingSDK", "1.2.0-alpha"
  spec.dependency "NautilusAnalyticsSDK", "1.2.0-alpha"
  spec.dependency "NautilusUISDK", "1.2.0-alpha"
  spec.dependency "NautilusLotterySDK", "1.2.0-alpha"
  spec.dependency "NautilusServerTimeSDK", "1.2.0-alpha"
