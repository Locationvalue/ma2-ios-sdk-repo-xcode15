Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusImagingSDK", "1.2.2"
  spec.dependency "NautilusAnalyticsSDK", "1.2.2"
  spec.dependency "NautilusUISDK", "1.2.2"
  spec.dependency "NautilusLotterySDK", "1.2.2"
  spec.dependency "NautilusServerTimeSDK", "1.2.2"
