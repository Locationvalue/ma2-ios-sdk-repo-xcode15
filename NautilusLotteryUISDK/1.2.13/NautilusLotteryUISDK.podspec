Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusCoreSDK", "1.2.13"
  spec.dependency "NautilusContainerSDK", "1.2.13"
  spec.dependency "NautilusConfigSDK", "1.2.13"
  spec.dependency "NautilusIdentifySDK", "1.2.13"
  spec.dependency "NautilusLoggingSDK", "1.2.13"
  spec.dependency "NautilusImagingSDK", "1.2.13"
  spec.dependency "NautilusAnalyticsSDK", "1.2.13"
  spec.dependency "NautilusUISDK", "1.2.13"
  spec.dependency "NautilusLotterySDK", "1.2.13"
  spec.dependency "NautilusServerTimeSDK", "1.2.13"
