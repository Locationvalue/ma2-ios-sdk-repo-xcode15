Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusImagingSDK", "1.4.4"
  spec.dependency "NautilusAnalyticsSDK", "1.4.4"
  spec.dependency "NautilusUISDK", "1.4.4"
  spec.dependency "NautilusLotterySDK", "1.4.4"
  spec.dependency "NautilusServerTimeSDK", "1.4.4"
