Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusCoreSDK", "1.6.3"
  spec.dependency "NautilusContainerSDK", "1.6.3"
  spec.dependency "NautilusConfigSDK", "1.6.3"
  spec.dependency "NautilusIdentifySDK", "1.6.3"
  spec.dependency "NautilusLoggingSDK", "1.6.3"
  spec.dependency "NautilusImagingSDK", "1.6.3"
  spec.dependency "NautilusAnalyticsSDK", "1.6.3"
  spec.dependency "NautilusUISDK", "1.6.3"
  spec.dependency "NautilusLotterySDK", "1.6.3"
  spec.dependency "NautilusServerTimeSDK", "1.6.3"
