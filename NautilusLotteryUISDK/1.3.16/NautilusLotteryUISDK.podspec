Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusImagingSDK", "1.3.16"
  spec.dependency "NautilusAnalyticsSDK", "1.3.16"
  spec.dependency "NautilusUISDK", "1.3.16"
  spec.dependency "NautilusLotterySDK", "1.3.16"
  spec.dependency "NautilusServerTimeSDK", "1.3.16"
