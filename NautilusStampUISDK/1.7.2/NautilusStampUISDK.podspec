Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusStampSDK", "1.7.2"
  spec.dependency "NautilusCodeReaderSDK", "1.7.2"
  spec.dependency "NautilusUISDK", "1.7.2"
  spec.dependency "NautilusServerTimeSDK", "1.7.2"
  spec.dependency "NautilusImagingSDK", "1.7.2"
