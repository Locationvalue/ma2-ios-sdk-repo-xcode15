Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusContainerSDK", "1.7.7"
  spec.dependency "NautilusCoreSDK", "1.7.7"
  spec.dependency "NautilusStampSDK", "1.7.7"
  spec.dependency "NautilusCodeReaderSDK", "1.7.7"
  spec.dependency "NautilusUISDK", "1.7.7"
  spec.dependency "NautilusServerTimeSDK", "1.7.7"
  spec.dependency "NautilusImagingSDK", "1.7.7"
