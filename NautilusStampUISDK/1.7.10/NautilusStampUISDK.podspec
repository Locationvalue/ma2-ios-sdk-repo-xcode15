Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusAnalyticsSDK", "1.7.10"
  ...
  spec.dependency "NautilusStampSDK", "1.7.10"
  spec.dependency "NautilusCodeReaderSDK", "1.7.10"
  spec.dependency "NautilusUISDK", "1.7.10"
  spec.dependency "NautilusServerTimeSDK", "1.7.10"
  spec.dependency "NautilusImagingSDK", "1.7.10"
