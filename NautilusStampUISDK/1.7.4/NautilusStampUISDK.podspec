Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusConfigSDK", "1.7.4"
  spec.dependency "NautilusContainerSDK", "1.7.4"
  spec.dependency "NautilusCoreSDK", "1.7.4"
  spec.dependency "NautilusStampSDK", "1.7.4"
  spec.dependency "NautilusCodeReaderSDK", "1.7.4"
  spec.dependency "NautilusUISDK", "1.7.4"
  spec.dependency "NautilusServerTimeSDK", "1.7.4"
  spec.dependency "NautilusImagingSDK", "1.7.4"
