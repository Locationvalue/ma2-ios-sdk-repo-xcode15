Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusConfigSDK", "1.1.5"
  spec.dependency "NautilusIdentifySDK", "1.1.5"
  spec.dependency "NautilusAnalyticsSDK", "1.1.5"
  spec.dependency "NautilusNotificationSDK", "1.1.5"
  spec.dependency "NautilusImagingSDK", "1.1.5"
  spec.dependency "NautilusUISDK", "1.1.5"
