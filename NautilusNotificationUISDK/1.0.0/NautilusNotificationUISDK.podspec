Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusIdentifySDK", "1.0.0"
  spec.dependency "NautilusAnalyticsSDK", "1.0.0"
  spec.dependency "NautilusNotificationSDK", "1.0.0"
  spec.dependency "NautilusImagingSDK", "1.0.0"
  spec.dependency "NautilusUISDK", "1.0.0"
