Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusCoreSDK", "1.1.1"
  spec.dependency "NautilusContainerSDK", "1.1.1"
  spec.dependency "NautilusConfigSDK", "1.1.1"
  spec.dependency "NautilusIdentifySDK", "1.1.1"
  spec.dependency "NautilusAnalyticsSDK", "1.1.1"
  spec.dependency "NautilusNotificationSDK", "1.1.1"
  spec.dependency "NautilusImagingSDK", "1.1.1"
  spec.dependency "NautilusUISDK", "1.1.1"
  spec.dependency "NautilusLoggingSDK", "1.1.1"
