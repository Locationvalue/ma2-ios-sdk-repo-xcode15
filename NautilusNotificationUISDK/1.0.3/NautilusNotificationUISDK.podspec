Pod::Spec.new do |spec|
  ...
  spec.dependency "NautilusCoreSDK", "1.0.3"
  spec.dependency "NautilusContainerSDK", "1.0.3"
  spec.dependency "NautilusConfigSDK", "1.0.3"
  spec.dependency "NautilusIdentifySDK", "1.0.3"
  spec.dependency "NautilusAnalyticsSDK", "1.0.3"
  spec.dependency "NautilusNotificationSDK", "1.0.3"
  spec.dependency "NautilusImagingSDK", "1.0.3"
  spec.dependency "NautilusUISDK", "1.0.3"
  spec.dependency "NautilusLoggingSDK", "1.0.3"
